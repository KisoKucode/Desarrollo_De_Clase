...
Proyecto de ejemplo con modelos, servicios y una GUI mínima para la gestión de obras.

Ver el diagrama UML en `uml/museo.mmd` (Mermaid) o `uml/museo.puml` (PlantUML).
```mermaid
classDiagram
    class Obra {
      -String id
